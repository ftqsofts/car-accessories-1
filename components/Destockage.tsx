...
const BABY_SAFETY: Product = {
  ...
  description: "هاد الناموسية هي الحل المتكامل اللي غيهنيك هاد الصيف، حيث كتوفر لطفلك حماية كاملة وآمنة 100% من الناموس وكاع الحشرات بفضل شبكتها الرقيقة اللي كتمنعهم من الدخول وكتخلي الهواء يدوز نقي",
  price: 59,
  oldPrice: 145,
  gender: "female",
  images: [
...
const FAN: Product = {
  ...
  description: "تهناي من الصهد! مروحة خفيفة كتطوى ف الصاك ولا كتعلق ف العنق. فيها 5 سرعات، شاشة LED للبطارية، وستاند للتيليفون باش تفرجي وتبردي ف دقة. بطارية 1800mAh كتشحن بـ USB وكتدوم طويل.",
  price: 49,
  oldPrice: 119,
  gender: "female",
  images: [
...
const CAMEL_FAT: Product = {
  ...
  description: "تهنا من حريق المفاصل، الظهر والركبة! مرهم دهن سنام الجمل (Sanambio) طبيعي وآمن 100%، كيعطي مفعول سريع باش ترجع حيويتك. العبوة فيها 100 مل.",
  price: 99,
  oldPrice: 199,
  gender: "both",
  images: [
...
const ALL_UPSELLS: Product[] = [LOCK, SILICONE_CLEANER, KITCHEN_BARRIER, ANTI_VIBRATION, FRONT_SUNSHADE, SAFE_BOX, BABY_SAFETY, CAMEL_FAT]
