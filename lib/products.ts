...
export const products: Product[] = [
  {
    ...
    price: 55,
    descriptionDarija:
      "مع هاد المكنسة غادي تنقي طوموبيلك فدقائق بلا تعب. الغبرة، الوسخ، بقايا الماكلة… كلشي كيتحيد بسهولة حتى من أصعب البلايص. صغيرة وخفيفة، ديما معاك .",
    featuresDarija: [
