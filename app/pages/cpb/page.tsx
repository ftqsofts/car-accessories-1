    ...
    <div className="min-h-screen bg-white text-gray-900" dir="rtl">
      ...
      <section className="relative flex flex-col items-center px-0 pb-0 overflow-hidden" style={{ backgroundColor: "#030712" }}>
        ...
        <div className="relative z-10 text-center px-6 pb-4">
          ...
          <p className="text-white/80 font-bold text-lg mt-2">3 منتجات أساسية لسيارتك فالصيف</p>
        </div>

        {/* Pack image */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/products/pack-b.png" alt="باك الحماية" width={800} height={600} className="w-full h-auto z-10 relative" style={{ display: "block" }} fetchPriority="high" decoding="sync" />
